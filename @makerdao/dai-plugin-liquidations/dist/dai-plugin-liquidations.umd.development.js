(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ramda'), require('tslib'), require('@makerdao/services-core'), require('@makerdao/dai'), require('assert'), require('ethers'), require('lodash-es/times'), require('bignumber.js')) :
  typeof define === 'function' && define.amd ? define(['exports', 'ramda', 'tslib', '@makerdao/services-core', '@makerdao/dai', 'assert', 'ethers', 'lodash-es/times', 'bignumber.js'], factory) :
  (global = global || self, factory(global['@makerdao/dai-plugin-liquidations'] = {}, global.ramda, global.tslib, global.servicesCore, global.dai, global.assert, global.ethers, global.times, global.BigNumber));
}(this, (function (exports, ramda, tslib, servicesCore, dai, assert, ethers, times, BigNumber) { 'use strict';

  assert = assert && Object.prototype.hasOwnProperty.call(assert, 'default') ? assert['default'] : assert;
  times = times && Object.prototype.hasOwnProperty.call(times, 'default') ? times['default'] : times;
...
//# sourceMappingURL=dai-plugin-liquidations.umd.development.js.map
