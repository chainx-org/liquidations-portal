(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('debug'), require('lodash-es/uniq'), require('lodash-es/values'), require('toposort')) :
  typeof define === 'function' && define.amd ? define(['exports', 'debug', 'lodash-es/uniq', 'lodash-es/values', 'toposort'], factory) :
  (global = global || self, factory(global['@makerdao/services-core'] = {}, global.debug, global.uniq, global.values, global.toposort));
}(this, (function (exports, debug, uniq, values, toposort) { 'use strict';
  ...
  values = values && Object.prototype.hasOwnProperty.call(values, 'default') ? values['default'] : values;
  toposort = toposort && Object.prototype.hasOwnProperty.call(toposort, 'default') ? toposort['default'] : toposort;
...
//# sourceMappingURL=services-core.umd.development.js.map
