...
var e = require("@makerdao/services-core"),
    n = require("lodash/fp"),
    a = t(require("invariant")),
    r = t(require("eth-lib/lib/account")),
    i = t(require("web3-provider-engine/dist/es5/subproviders/wallet")),
    s = t(require("web3-provider-engine/dist/es5")),
    o = t(require("web3-provider-engine/dist/es5/subproviders/websocket")),
    u = t(require("web3-provider-engine/dist/es5/subproviders/rpc")),
    c = t(require("web3-provider-engine/dist/es5/subproviders/subscriptions")),
    p = t(require("web3-provider-engine/dist/es5/subproviders/provider")),
    y = require("assert"),
    d = t(y),
    l = t(require("bignumber.js")),
    m = t(require("debug")),
    f = require("tslib"),
    b = require("lodash"),
    h = require("ethers"),
    v = require("@makerdao/currency"),
    _ = t(require("eventemitter2")),
    w = t(require("isomorphic-fetch")),
    g = require("@makerdao/multicall"),
    x = require("rxjs"),
...
function Y() {
    return (Y = M(H.mark((function t(e) {
        var n, a, r, i, y, d, l;
...
function J() {
    return (J = M(H.mark((function t(e, n) {
        var a, r, i, s;
        return H.wrap((function (t) {
            for (;;) switch (t.prev = t.next) {
                case 0:
                    return s = (a = void 0 === n ? {} : n).address, d(!((i = void 0 === (r = a.offset) ? 0 : r) && s), "Cannot set both address and offset"), t.abrupt("return", new Promise((function (t, n) {
                        return e.handleRequest({
                            ...
                            if (s) {
                                ...
                                d(r, "No matching address found in provider."), t(r.toLowerCase())
...
function $() {
    return ($ = M(H.mark((function t(e, n) {
        var a, r, i;
        return H.wrap((function (t) {
            for (;;) switch (t.prev = t.next) {
                case 0:
...
var et = "0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff",
    ...
    it = function (t) {
        ...
        return r.initialize = function () {
            var t = M(H.mark((function t(e) {
                var a;
                return H.wrap((function (t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return void 0 === e && (e = {}), this._settings = n.omit("web3", e), t.next = 4, W(e);
                        case 4:
            ...
            var t = M(H.mark((function t(e, n) {
                ...
                return H.wrap((function (t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            if (void 0 === n && (n = {}), e && "string" != typeof e && (n = e, e = null), i = (r = n).type, s = r.autoSwitch, o = D(r, nt), this._engine || a(!1), !e || !this._accounts[e]) {
                                t.next = 6;
                                break
                            }
                ...
                return H.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
                            return e.next = 2, 0;
                        case 2:
                            return s.promise || (s.promise = u), a = [].concat(n, b.times(i - 1 - n.length, (function () {})), [s]), e.abrupt("return", r.apply(t, a));
                        case 5:
                        case "end":
                            return e.stop()
                    }
...
var ct = new l(et).shiftedBy(-18),
    pt = function (t) {
        ...
        return n.initialize = function (t) {
            ...
            var t = M(H.mark((function t(e, n, a) {
                var r, i, s, o, u, c, p, y;
                return H.wrap((function (t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
...
f.__decorate([ot, f.__metadata("design:type", Function), f.__metadata("design:paramtypes", [Object, Object, Object]), f.__metadata("design:returntype", Promise)], pt.prototype, "requireAllowance", null), f.__decorate([ot, f.__metadata("design:type", Function), f.__metadata("design:paramtypes", [Object, Object, Object]), f.__metadata("design:returntype", Promise)], pt.prototype, "removeAllowance", null);
var yt = function (t) {
        function e(e) {
    ...
    mt = function (t) {
        ...
        return n.authenticate = function () {
            ...
            return new h.Contract(t, lt.dappHub.dsProxy, this.get("web3").getEthersSigner())
        }, e
    }(e.PrivateService);
f.__decorate([ot, f.__metadata("design:type", Function), f.__metadata("design:paramtypes", [Object]), f.__metadata("design:returntype", Promise)], mt.prototype, "ensureProxy", null), f.__decorate([ot, f.__metadata("design:type", Function), f.__metadata("design:paramtypes", [Object]), f.__metadata("design:returntype", Promise)], mt.prototype, "build", null);
var ft = {
        MKR: "MKR",
        WETH: "WETH",
        PETH: "PETH",
...
var wt = [{
    ...
    gt = b.values(ft).reduce((function (t, e) {
        return t[e] = v.createCurrency(e), t
    }), {
        USD: v.createCurrency("USD")
    }),
    xt = v.createGetCurrency(gt),
    At = gt.ETH,
    Tt = gt.MKR,
    kt = gt.PETH,
    St = gt.WETH,
    Mt = gt.USD,
    Et = v.createCurrencyRatio(Mt, At),
    Ct = v.createCurrencyRatio(Mt, Tt),
    Pt = v.createCurrencyRatio(Mt, kt),
    Ot = v.createCurrencyRatio(Mt, St);
Object.assign(gt, {
    USD_ETH: Et,
    USD_MKR: Ct,
    USD_PETH: Pt,
...
var It = ["unit"],
    Rt = function () {
        ...
        return e.allowance = function () {
            ...
            var a = void 0 === n ? {} : n,
                ...
                s = D(a, It);
            return this._contract.approve(t, this._valueForContract(e, i), P({
                metadata: {
                    action: {
                        name: "approve",
                        spender: t,
            ...
            return void 0 === e && (e = {}), t || (t = this._web3.currentAddress()), this._contract.approve(t, h.ethers.BigNumber.from(et), P({
                metadata: {
                    action: {
                        name: "approve",
                        spender: t,
    ...
    Bt = function () {
        ...
        return e.allowance = function (t, e) {
            ...
            var t = M(H.mark((function t(e, n, a, r) {
                var i, s, o, u;
                return H.wrap((function (t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return o = r.promise, u = h.ethers.BigNumber.from(xt(a, s = void 0 === (i = r.unit) ? At : i).toFixed("wei"))._hex, t.abrupt("return", this._transactionManager.sendTransaction({
                                from: e,
                                to: n,
                                value: u
                            }, {
...
f.__decorate([ot, f.__metadata("design:type", Function), f.__metadata("design:paramtypes", [Object, Object, Object]), f.__metadata("design:returntype", Promise)], Bt.prototype, "transfer", null), f.__decorate([ot, f.__metadata("design:type", Function), f.__metadata("design:paramtypes", [Object, Object, Object, Object]), f.__metadata("design:returntype", Promise)], Bt.prototype, "transferFrom", null);
var Lt = ["unit"],
    Ft = ["unit"],
    Dt = function (t) {
        function e(e, n, a) {
        ...
        return n.name = function () {
            ...
            var n = void 0 === e ? {} : e,
                ...
                r = void 0 === a ? At : a,
                i = D(n, Lt);
            return this._contract.deposit(P({
    ...
    Nt = function (t) {
        ...
        return n.initialize = function (t) {
            ...
            if (t.symbol && (t = t.symbol), d(t, "Symbol is blank"), d(this.getTokens().indexOf(t) >= 0, 'Symbol "' + t + '" is not recognized'), t === ft.ETH) return new Bt(this.get("web3"), this.get("gas"), this.get("transactionManager"));
            ...
            d(r, 'Cannot find token info for "' + t + '"');
            var i = e ? r[e - 1] : r[r.length - 1];
            return this._addressOverrides[t] && (i.address = this._addressOverrides[t]), "string" == typeof i.address ? i : P({}, i, {
            ...
            return M(H.mark((function t() {
                ...
                return H.wrap((function (t) {
                    for (;;) switch (t.prev = t.next) {
                        ...
                        case 5:
                            b.isEqual(i, r = t.sent) || (a(e, r), i = r), t.next = 13;
                            break;
                        case 9:
...
var zt = _.EventEmitter2,
    ...
    Vt = function (t) {
        ...
        return n.initialize = function (t) {
            ...
            var n = this;
            if ("default" !== t) return b.map(t, (function (t, a) {
            ...
            var t = M(H.mark((function t() {
                return H.wrap((function (t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return t.prev = 0, t.next = 3, w("https://ethgasstation.info/json/ethgasAPI.json?api-key=" + this._settings.apiKey);
                        case 3:
    ...
    Qt = m("dai:MulticallService"),
    $t = m("dai:MulticallService:observables"),
    Zt = function (t) {
    ...
    te = function (t) {
        return void 0 === b.find(t, (function (t) {
            return t instanceof Error
        }))
    },
    ee = function (t) {
        return function (e) {
            return A.catchError((function (e) {
                return $t("Caught nested error in " + t + ": " + e), x.from([new Error(e)])
            }))(e)
        }
    },
    ne = function (t) {
        ...
        return n.initialize = function (t) {
            ...
            var y = "block" === s;
            return y && (s = 6e4), r ? c.web3 = p._web3 : u || (u = p.rpcUrl), this._watcher = g.createWatcher([], P({}, c, {
                interval: s,
                rpcUrl: u
            ...
            return this._watch.apply(this, [{
                depth: 0,
                throwIfError: !0
            }, t].concat(n)).pipe(A.catchError((function (t) {
                throw new Error(t)
            })), A.takeUntil(x.timer(this._latestTimeout)), A.throwIfEmpty((function () {
                return new Error("Timed out waiting for latest value of: " + r)
            })), A.debounceTime(this._latestDebounceTime), A.take(1)).toPromise()
        }, n.watch = function (t) {
            for (var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), a = 1; a < e; a++) n[a - 1] = arguments[a];
            return this._watch.apply(this, [{
                depth: 0
            ...
            if (p.length < u) return x.throwError("Observable " + e + " expects at least " + u + " argument(s)");
            var d = e + (p.length > 0 ? "." : "") + p.join(".");
            if (null != o && null != (n = o.validate) && n.args) {
                var l, m = (l = o.validate).args.apply(l, p);
                if (m) return $t("Input validation failed for observable: " + d + " (depth: " + r + ")"), x.throwError(m)
            }
            var f = this._createSchemaInstance.apply(this, [o].concat(p)),
                h = f.computed;
            $t("watch() called for " + (h ? "computed " : "base ") + "observable: " + d + " (depth: " + r + ")");
            var v = b.get(this._observables, d);
            if (v) return h ? ($t("Returning existing computed observable: " + d + " (depth: " + r + ")"), 0 === r && (v = v.pipe(A.debounceTime(this._debounceTime))), s && (v = v.pipe(A.tap(Zt))), v.pipe(A.filter(te), A.map((function (t) {
                return h.apply(void 0, t)
            })))) : ($t("Returning existing base observable: " + d), v);
            if (h) {
                var _ = "function" == typeof f.dependencies ? f.dependencies({
                    ...
                    w = function t(e) {
                        var n = e[0],
                            i = e.slice(1);
                        if (n instanceof Promise || Array.isArray(n)) return x.from(n);
                        if ("function" == typeof n) return x.from(n());
                        ...
                        return Array.isArray(i) && 0 === i.length ? a._watch({
                            ...
                            depth: r + 1
                        }, n].concat(i)) : x.combineLatest(i.map((function (e, n) {
                            return s[n] ? [e] : t(e)
                        }))).pipe(A.flatMap((function (t) {
                    ...
                    g = _.map(w),
                    T = x.combineLatest(g);
                return $t("Created new computed observable: " + d + " (depth: " + r + ")"), b.set(this._observables, d, T), 0 === r && (T = T.pipe(A.debounceTime(this._debounceTime))), s && (T = T.pipe(A.tap(Zt))), T.pipe(A.filter(te), A.map((function (t) {
                    return h.apply(void 0, t)
                })))
            }
            var k = f.id,
            ...
            var M = new x.ReplaySubject(1);
            b.set(this._subjects, d, M), void 0 !== this._multicallResultCache[d] && this._handleResult(M, d, this._multicallResultCache[d]);
            var E = x.Observable.create((function (t) {
                a._totalSchemaSubscribers++, $t("Observer subscribed to " + k + " (" + (a._schemaSubscribers[S] + 1) + " subscribers)"), 1 == ++a._schemaSubscribers[S] && a._addSchemaToMulticall(f), a._watcherUpdates || a._subscribeToWatcherUpdates();
                var e = M.subscribe(t);
                return function () {
                    a._totalSchemaSubscribers--, 0 == --a._schemaSubscribers[S] && a._removeSchemaFromMulticall(f.id), e.unsubscribe(), $t("Observer unsubscribed from " + k + " (" + a._schemaSubscribers[S] + " subscribers)")
                }
            }));
            return $t("Created new base observable: " + d), b.set(this._observables, d, E), E
            ...
            $t("Subscribed to watcher updates"), this._watcherUpdates = this._watcher.subscribe((function (e) {
                var n = b.get(t._subjects, e.type);
                if (n) {
    ...
    se = function (t) {
        ...
        return n.initialize = function (t) {
            ...
            var a = void 0 === n ? {} : n,
                ...
                i = a.wrap,
                s = void 0 === i || i;
            d(t, 'Missing address for contract "' + r + '"'), r || (r = this.lookupContractName(t));
            var o = this.get("web3"),
            ...
            }(new h.Contract(t, e, u), r, e, s && this.get("transactionManager"))
            ...
            return b.mapValues(this._getAllContractInfo(), (function (t) {
                return ue(t).address
            }))
            ...
            d(this.hasContract(t), 'No contract found for "' + t + '"');
            var n = oe(this._getAllContractInfo()[t], e);
            return d(n, "Cannot find contract " + t + ", version " + e), d(n.address, "Contract " + t + " has no address"), n
            ...
            if (d(n, 'Network "' + e + '" not found in mapping.'), n.contracts || (n.contracts = vt(this._addressOverrides)), this._contractInfoCache || (this._contractInfoCache = {}), !this._contractInfoCache[e]) {
                var a = this._addedContracts ? P({}, n.contracts, this._addedContracts) : n.contracts;
                this._contractInfoCache[e] = b.mapValues(a, (function (n, a) {
                    var r = ue(n),
...
var pe = function (t) {
    ...
    ge = function (t) {
        ...
        return n.timeStampSubmitted = function () {
            ...
            return t < 1 ? a : a.then((function (a) {
                return a || (we("Receipt is null. Retrying " + t + " more time(s)"), Gt(1500 * e).then((function () {
            ...
            var t = M(H.mark((function t() {
                ...
                return H.wrap((function (t) {
                    for (;;) switch (t.prev = t.next) {
                        ...
                        case 9:
                            return we("not mined yet"), t.next = 12, Gt(5e3);
                        case 12:
                            a++, t.next = 3;
                            break;
                        case 15:
    ...
    Ae = function (t) {
        ...
        return n.sendContractCall = function (t, e, n, a) {
            var r = this;
            xe("sendContractCall: " + a + "." + e + " " + T.inspect(n)), n || (n = []);
            var i, s, o, u = {
                    contract: a,
                    method: e.replace(/\(.*\)$/g, ""),
                    args: n
                ...
                c = n[n.length - 1];
            return "object" == typeof c && c.constructor === Object ? (i = c, n = n.slice(0, n.length - 1), i.metadata && (u = P({}, u, i.metadata), delete i.metadata), b.has(i, "promise") && (i.promise && (s = i.promise), delete i.promise), i.businessObject && (o = i.businessObject, delete i.businessObject), b.has(i, "value") || (i.value = 0)) : i = {}, this._createTransactionObject(M(H.mark((function a() {
            ...
            var n = this;
            return this._createTransactionObject(M(H.mark((function e() {
                var a;
                return H.wrap((function (e) {
                    for (;;) switch (e.prev = e.next) {
                        case 0:
            ...
            return this._tracker.get(Ht(t), e)
        }, n.confirm = function () {
            var t = M(H.mark((function t(e, n) {
                var a;
                return H.wrap((function (t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return t.next = 2, e;
                        case 2:
                            return a = this._tracker.getAll(Ht(e)), t.abrupt("return", Promise.all(a.map((function (t) {
                                return t.confirm(n)
                            }))));
                        case 4:
                        case "end":
            ...
            return this._tracker.get(Ht(t)).isMined()
        }, n.listen = function (t, e) {
            this._tracker.listen(Ht(t), "function" == typeof e ? {
                pending: function (t) {
                    return e(t, "pending")
                },
                mined: function (t) {
            ...
            var i = r.mine();
            return this._tracker.store(Ht(i), r), a && this._tracker.store(Ht(a), r, {
                ...
                return H.wrap((function (t) {
                    for (;;) switch (t.prev = t.next) {
                        ...
                        case 8:
                            e.gasPrice = t.sent;
                        case 9:
                            return t.t0 = P, t.t1 = {}, t.t2 = e, t.t3 = this.get("web3").transactionSettings(), t.next = 15, this.get("nonce").getNonce();
                        case 15:
            ...
            var t = M(H.mark((function t(e, n, a, r) {
                ...
                return H.wrap((function (t) {
                    for (;;) switch (t.prev = t.next) {
                        ...
                        case 8:
                            return e.value && (i.value = e.value), i = P({
    ...
    Te = function () {
        ...
        return e.store = function (t, e, n) {
            ...
            var t = this;
            b.each(this._transactions, (function (e, n) {
...
var ke = new(function () {
    ...
    Se = m("dai:Web3Service"),
    Me = function (t) {
        function e(e) {
            var n;
            return void 0 === e && (e = "web3"), (n = t.call(this, e, ["accounts", "timer", "cache", "event"]) || this)._blockListeners = {}, n._info = {}, ke.push(j(n)), n
        }
        O(e, t);
        var n = e.prototype;
        return n.currentAddress = function () {
            ...
            var e = this;
            Se("initializing..."), this._defaultEmitter = this.get("event"), this._web3 = new k, this._web3.setProvider(this.get("accounts").getProvider()), this.eth = new Proxy(this, {
                get: function (t, e) {
            ...
            var t = M(H.mark((function t() {
                return H.wrap((function (t) {
                    for (;;) switch (t.prev = t.next) {
                        ...
                        case 8:
                            this._currentBlock = t.sent, this._updateBlockNumber(this._currentBlock), this._listenForNewBlocks(), this.onNewBlock(this.get("event").ping), this._defaultEmitter.emit("web3/CONNECTED", P({}, this._info));
                        case 13:
                        case "end":
                            return t.stop()
                    }
            ...
            key: "network",
            get: function () {
                return d(this._networkId, "Cannot resolve network ID. Are you connected?"), this._networkId
            }
        }, {
            key: "networkName",
            get: function () {
            ...
            key: "rpcUrl",
            get: function () {
                var t = b.last(this._web3.currentProvider._providers);
...
function Ee(t, n, a, r) {
    return n = e.standardizeConfig(t, n, r), a = e.standardizeConfig(t, a), !1 === n[0] || !1 === a[0] ? a : ["boolean" != typeof a[0] ? a[0] : n[0], b.merge({}, n[1], a[1])]
}
...
var Pe = {
    ...
    Oe = function (t) {
        function e(e) {
            return void 0 === e && (e = {}), e.web3 && (e = P({}, e, {
                accounts: P({}, e.accounts, {
                    web3: Ce(e.web3)
                })
            })), t.call(this, e, P({
                services: {
    ...
    Ge = ["accounts", "allowance", "gas", "multicall", "nonce", "proxy", "smartContract", "timer", "token", "transactionManager", "web3"],
    He = ["accounts", "overrideMetamask", "plugins", "privateKey", "provider", "url"],
    We = ["plugins"],
    Ye = ["plugins"],
    ...
    Ke = function () {
        function t(t, e, n) {
            ...
            for (var a, r = e.plugins, i = void 0 === r ? [] : r, s = D(e, We), o = U(i); !(a = o()).done;) {
                var u = a.value,
                    c = u[0];
            ...
            var p = function (t, e, n) {
                ...
                ! function (t) {
                    var e = b.intersection(t, He);
                    if (e.length > 0) throw new Error("The following words cannot be used as service role names: " + e.join(", "))
                }(r);
                for (var i, s = U(Ge.concat(r)); !(i = s()).done;) {
                    var o = i.value;
                    o in e && (a[o] = o in a ? Ee(o, a[o], e[o], n) : e[o])
                }
                if (a.web3) {
                    var u = a.web3[1] || a.web3;
                    u.provider || (u.provider = {}), e.url && (u.provider.url = e.url), e.provider && b.merge(u.provider, e.provider)
                }
                return e.privateKey && (a.accounts = P({}, a.accounts, {
                    default: {
                        type: "privateKey",
                        key: e.privateKey
                    }
            ...
            this._container = new Oe(p).buildContainer();
...
function Xe(t, e) {
    return b.mergeWith(t, e, (function (t, e, n) {
        return Array.isArray(t) && "abi" === n ? b.uniq(t) : Array.isArray(t) && "abi" !== n ? b.uniq(t.concat(e)) : void 0
    }))
}
var qe = function (t) {
...
function Ve() {
    return (Ve = M(H.mark((function t() {
        var e, n, a, r, i, s, o, u, c, p, y, d, l, m, f, h = arguments;
        return H.wrap((function (t) {
            for (;;) switch (t.prev = t.next) {
                case 0:
                    for (e = h.length, n = new Array(e), a = 0; a < e; a++) n[a] = h[a];
                    if (r = n[0], o = (s = void 0 === (i = n[1]) ? {} : i).plugins, u = D(s, Ye), c = b.cloneDeep(u), !o) {
                        t.next = 18;
                        break
                    }
                ...
                case 16:
                    ...
                    break;
                case 18:
                    if (f = new Ke(r, s, c), !1 === s.autoAuthenticate) {
                        t.next = 22;
                        break
                    }
                    return t.next = 22, f.authenticate();
                case 22:
...
function Qe(t, e) {
    void 0 === e && (e = !0);
    var n = h.utils.toUtf8Bytes(t);
    if (n.length > 32) throw new Error("too long");
    return h.utils.hexlify(e ? h.utils.zeroPad(n, 32) : n)
}
...
function tn() {
    return (tn = M(H.mark((function t(e, n, a) {
        var r, i;
        return H.wrap((function (t) {
            for (;;) switch (t.prev = t.next) {
                case 0:
                ...
                case 5:
                    return d(i = t.sent.data, "error fetching data from " + e), t.abrupt("return", i);
                case 9:
                case "end":
                    return t.stop()
            }
...
var nn = {
    ...
    an = {
        numberToBytes32: function (t) {
            var e = h.BigNumber.from(t);
            return h.utils.hexlify(h.utils.zeroPad(e, 32))
        },
        stringToBytes32: Qe,
        bytes32ToNumber: function (t) {
            return h.BigNumber.from(t).toNumber()
        },
        stringToBytes: function (t) {
            return d(!!t, "argument is falsy"), d("string" == typeof t, "argument is not a string"), "0x" + Buffer.from(t).toString("hex")
        },
...
exports.ETH = At, exports.MKR = Tt, exports.PETH = kt, exports.QueryApi = nn, exports.USD = Mt, exports.USD_ETH = Et, exports.USD_MKR = Ct, exports.USD_PETH = Pt, exports.USD_WETH = Ot, exports.WETH = St, exports.currencies = gt, exports.default = Je, exports.getCurrency = xt, exports.utils = an;
//# sourceMappingURL=dai.cjs.production.min.js.map