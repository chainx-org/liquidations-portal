import { PublicService, PrivateService, LocalService, StateMachine, standardizeConfig, ServiceProvider } from '@makerdao/services-core';
import { map, pick, omit } from 'lodash/fp';
...
import { times, values, isEqual, map as map$1, get, set, find, mapValues, has, each, last, merge, intersection, cloneDeep, mergeWith, uniq } from 'lodash-es';
import { Contract, ethers, BigNumber as BigNumber$1, utils as utils$1 } from 'ethers';
import { createCurrency, createGetCurrency, createCurrencyRatio } from '@makerdao/currency';
import EventEmitterObj from 'eventemitter2';
import fetch from 'isomorphic-fetch';
import { createWatcher } from '@makerdao/multicall';
import { timer, throwError, combineLatest, ReplaySubject, Observable, from } from 'rxjs';
import { catchError, takeUntil, throwIfEmpty, debounceTime, take, tap, filter, map as map$2, flatMap } from 'rxjs/operators';
...
var sanitizeAccount = /*#__PURE__*/pick(['name', 'type', 'address']);
...
var AccountsService = /*#__PURE__*/function (_PublicService) {
  ...
  _proto.addAccountType = function addAccountType(type, factory) {
    !!this._accountFactories[type] ? process.env.NODE_ENV !== "production" ? invariant(false, "Account type \"" + type + "\" is already defined") : invariant(false) : void 0;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              !this._engine ? process.env.NODE_ENV !== "production" ? invariant(false, 'engine must be set up before adding an account') : invariant(false) : void 0;
            ...
            case 6:
              ...
              !factory ? process.env.NODE_ENV !== "production" ? invariant(false, "no factory for type \"" + type + "\"") : invariant(false) : void 0;
              _context3.next = 10;
  ...
  _proto.useAccount = function useAccount(name) {
    ...
    !account ? process.env.NODE_ENV !== "production" ? invariant(false, "No account found with name \"" + name + "\".") : invariant(false) : void 0;
  ...
  _proto.currentAccount = function currentAccount() {
    !this.hasAccount() ? process.env.NODE_ENV !== "production" ? invariant(false, 'No account is set up.') : invariant(false) : void 0;
...
__decorate([tracksTransactions, __metadata("design:type", Function), __metadata("design:paramtypes", [Object, Object, Object]), __metadata("design:returntype", Promise)], AllowanceService.prototype, "requireAllowance", null);

__decorate([tracksTransactions, __metadata("design:type", Function), __metadata("design:paramtypes", [Object, Object, Object]), __metadata("design:returntype", Promise)], AllowanceService.prototype, "removeAllowance", null);
...
var DSProxyService = /*#__PURE__*/function (_PrivateService) {
  ...
  _proto.getUnwrappedProxyContract = function getUnwrappedProxyContract(address) {
    return new Contract(address, abis.dappHub.dsProxy, this.get('web3').getEthersSigner());
  };

  return DSProxyService;
}(PrivateService);

__decorate([tracksTransactions, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], DSProxyService.prototype, "ensureProxy", null);

__decorate([tracksTransactions, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Promise)], DSProxyService.prototype, "build", null);
...
var currencies = /*#__PURE__*/values(tokens).reduce(function (output, symbol) {
  output[symbol] = createCurrency(symbol);
  return output;
}, {
  USD: /*#__PURE__*/createCurrency('USD')
});
var getCurrency = /*#__PURE__*/createGetCurrency(currencies); // we export both the currencies object and the individual currencies because
...
var USD_ETH = /*#__PURE__*/createCurrencyRatio(USD, ETH);
var USD_MKR = /*#__PURE__*/createCurrencyRatio(USD, MKR);
var USD_PETH = /*#__PURE__*/createCurrencyRatio(USD, PETH);
var USD_WETH = /*#__PURE__*/createCurrencyRatio(USD, WETH);
...
var Erc20Token = /*#__PURE__*/function () {
  ...
  _proto.approveUnlimited = function approveUnlimited(spender, options) {
    ...
    return this._contract.approve(spender, ethers.BigNumber.from(UINT256_MAX), _extends({
      metadata: {
        action: {
          name: 'approve',
          spender: spender,
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              curAmt = ethers.BigNumber.from(getCurrency(amount, unit).toFixed('wei'))._hex;
...
__decorate([tracksTransactions, __metadata("design:type", Function), __metadata("design:paramtypes", [Object, Object, Object]), __metadata("design:returntype", Promise)], EtherToken.prototype, "transfer", null);

__decorate([tracksTransactions, __metadata("design:type", Function), __metadata("design:paramtypes", [Object, Object, Object, Object]), __metadata("design:returntype", Promise)], EtherToken.prototype, "transferFrom", null);
...
var EthereumTokenService = /*#__PURE__*/function (_PrivateService) {
  ...
  _proto.getToken = function getToken(symbol, version) {
    ...
    assert(this.getTokens().indexOf(symbol) >= 0, "Symbol \"" + symbol + "\" is not recognized");
...
var GasService = /*#__PURE__*/function (_PublicService) {
  ...
  _proto._setProperties = function _setProperties(settings, label) {
    ...
    return map$1(settings, function (value, key) {
      if (key === 'disable') {
...
var MulticallService = /*#__PURE__*/function (_PublicService) {
  ...
  _proto.createWatcher = function createWatcher$1(_temp) {
    var _this2 = this;
    ...
    this._watcher = createWatcher([], _extends({}, config, {
      interval: interval,
      rpcUrl: rpcUrl
    }));
  ...
  _proto._watch = function _watch(_ref3, key) {
    ...
    if (args.length < expectedArgs) return throwError("Observable " + key + " expects at least " + expectedArgs + " argument(s)");
    var obsPath = "" + key + (args.length > 0 ? '.' : '') + args.join('.');
    ...
    if (existing) {
      if (computed) {
        ...
        return existing.pipe(filter(checkForErrors), map$2(function (result) {
    ...
    if (computed) {
      ...
      set(this._observables, obsPath, _observable);
      ...
      return _observable.pipe(filter(checkForErrors), map$2(function (result) {
        return computed.apply(void 0, result);
      }));
    }
...
var TransactionManager = /*#__PURE__*/function (_PublicService) {
  ...
  _proto.sendContractCall = function sendContractCall(contract, method, args, name) {
    ...
    log$4("sendContractCall: " + name + "." + method + " " + inspect(args));
    if (!args) args = [];
    var options,
        promise,
        businessObject,
...
function mergeOptions(object, source) {
  return mergeWith(object, source, function (objValue, srcValue, key) {
    ...
    if (Array.isArray(objValue) && key !== 'abi') return uniq(objValue.concat(srcValue));
  });
}
...
var standardizePluginConfig = function standardizePluginConfig(plugins) {
  return plugins.map(function (x, i) {
    ...
    strict(PLUGIN_KEYS.some(function (x) {
      return has(plugin, x);
...
function numberToBytes32(num) {
  var bn = BigNumber$1.from(num);
  return utils$1.hexlify(utils$1.zeroPad(bn, 32));
}
function bytes32ToNumber(bytes32) {
  return BigNumber$1.from(bytes32).toNumber();
}
function stringToBytes32(text, pad) {
  ...
  var data = utils$1.toUtf8Bytes(text);
  ...
  if (pad) {
    return utils$1.hexlify(utils$1.zeroPad(data, 32));
  }

  return utils$1.hexlify(data);
}
...
export { ETH, MKR, PETH, QueryApi, USD, USD_ETH, USD_MKR, USD_PETH, USD_WETH, WETH, currencies, getCurrency, utils };
//# sourceMappingURL=dai.esm.js.map
