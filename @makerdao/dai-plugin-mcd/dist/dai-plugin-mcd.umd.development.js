(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('assert'), require('lodash-es/mapValues'), require('lodash-es/reduce'), require('lodash-es/uniqBy'), require('tslib'), require('@makerdao/currency'), require('@makerdao/services-core'), require('lodash-es/times'), require('bignumber.js'), require('web3'), require('ethers'), require('lodash-es/has'), require('lodash-es/padStart'), require('web3-eth-abi'), require('lodash-es/padEnd'), require('lodash-es/orderBy'), require('lodash-es/flatten')) :
  typeof define === 'function' && define.amd ? define(['exports', 'assert', 'lodash-es/mapValues', 'lodash-es/reduce', 'lodash-es/uniqBy', 'tslib', '@makerdao/currency', '@makerdao/services-core', 'lodash-es/times', 'bignumber.js', 'web3', 'ethers', 'lodash-es/has', 'lodash-es/padStart', 'web3-eth-abi', 'lodash-es/padEnd', 'lodash-es/orderBy', 'lodash-es/flatten'], factory) :
  (global = global || self, factory(global['@makerdao/dai-plugin-mcd'] = {}, global.assert, global.mapValues, global.reduce, global.uniqBy, global.tslib, global.currency, global.servicesCore, global.times, global.BigNumber, global.Web3, global.ethers, global.has, global.padStart, global.ethAbi, global.padEnd, global.orderBy, global.flatten));
}(this, (function (exports, assert, mapValues, reduce, uniqBy, tslib, currency, servicesCore, times, BigNumber, Web3, ethers, has, padStart, ethAbi, padEnd, orderBy, flatten) { 'use strict';
  ...
  padStart = padStart && Object.prototype.hasOwnProperty.call(padStart, 'default') ? padStart['default'] : padStart;
  ethAbi = ethAbi && Object.prototype.hasOwnProperty.call(ethAbi, 'default') ? ethAbi['default'] : ethAbi;
  ...
  flatten = flatten && Object.prototype.hasOwnProperty.call(flatten, 'default') ? flatten['default'] : flatten;
  ...
  */
  ...
  var ETH$3 = /*#__PURE__*/currency.createCurrency('ETH');
  var MKR = /*#__PURE__*/currency.createCurrency('MKR');
  var USD = /*#__PURE__*/currency.createCurrency('USD');
  var USD_ETH = /*#__PURE__*/currency.createCurrencyRatio(USD, ETH$3);
  var WETH = /*#__PURE__*/currency.createCurrency('WETH');
  var DAI = /*#__PURE__*/currency.createCurrency('DAI');
  var DSR_DAI = /*#__PURE__*/currency.createCurrency('DSR-DAI');
  var REP$1 = /*#__PURE__*/currency.createCurrency('REP');
  var ZRX$3 = /*#__PURE__*/currency.createCurrency('ZRX');
  var KNC$3 = /*#__PURE__*/currency.createCurrency('KNC');
  var OMG$1 = /*#__PURE__*/currency.createCurrency('OMG');
  var BAT$3 = /*#__PURE__*/currency.createCurrency('BAT');
  var DGD$1 = /*#__PURE__*/currency.createCurrency('DGD');
  var GNT$1 = /*#__PURE__*/currency.createCurrency('GNT');
  var USDC$3 = /*#__PURE__*/currency.createCurrency('USDC');
  var WBTC$3 = /*#__PURE__*/currency.createCurrency('WBTC');
  var TUSD$3 = /*#__PURE__*/currency.createCurrency('TUSD');
  var MANA$3 = /*#__PURE__*/currency.createCurrency('MANA');
  var USDT$3 = /*#__PURE__*/currency.createCurrency('USDT');
  var PAXUSD$3 = /*#__PURE__*/currency.createCurrency('PAXUSD');
  var COMP$3 = /*#__PURE__*/currency.createCurrency('COMP');
  var LRC$3 = /*#__PURE__*/currency.createCurrency('LRC');
  var LINK$3 = /*#__PURE__*/currency.createCurrency('LINK');
  var YFI$3 = /*#__PURE__*/currency.createCurrency('YFI');
  var BAL$3 = /*#__PURE__*/currency.createCurrency('BAL');
  var GUSD$3 = /*#__PURE__*/currency.createCurrency('GUSD');
  var UNI$3 = /*#__PURE__*/currency.createCurrency('UNI');
  var RENBTC$3 = /*#__PURE__*/currency.createCurrency('RENBTC');
  var AAVE$3 = /*#__PURE__*/currency.createCurrency('AAVE');
  var MATIC$3 = /*#__PURE__*/currency.createCurrency('MATIC');
  var WSTETH$3 = /*#__PURE__*/currency.createCurrency('WSTETH');
  var UNIV2DAIETH$3 = /*#__PURE__*/currency.createCurrency('UNIV2DAIETH');
  var UNIV2WBTCETH$3 = /*#__PURE__*/currency.createCurrency('UNIV2WBTCETH');
  var UNIV2USDCETH$3 = /*#__PURE__*/currency.createCurrency('UNIV2USDCETH');
  var UNIV2DAIUSDC$3 = /*#__PURE__*/currency.createCurrency('UNIV2DAIUSDC');
  var UNIV2ETHUSDT$3 = /*#__PURE__*/currency.createCurrency('UNIV2ETHUSDT');
  var UNIV2LINKETH$3 = /*#__PURE__*/currency.createCurrency('UNIV2LINKETH');
  var UNIV2UNIETH$3 = /*#__PURE__*/currency.createCurrency('UNIV2UNIETH');
  var UNIV2WBTCDAI$3 = /*#__PURE__*/currency.createCurrency('UNIV2WBTCDAI');
  var UNIV2AAVEETH$3 = /*#__PURE__*/currency.createCurrency('UNIV2AAVEETH');
  var UNIV2DAIUSDT$3 = /*#__PURE__*/currency.createCurrency('UNIV2DAIUSDT');
  var SAI$2 = /*#__PURE__*/currency.createCurrency('SAI');
  var defaultCdpTypes = [{
    currency: ETH$3,
    ilk: 'ETH-A'
  }, {
  ...
  function liquidationPrice(collateralAmount, debtValue, liquidationRatio) {
    if (collateralAmount.eq(0)) {
      var ratio = currency.createCurrencyRatio(USD, collateralAmount.type);
      return ratio(Infinity);
    }
  ...
  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object]), tslib.__metadata("design:returntype", void 0)], ManagedCdpClass.prototype, "drawDai", null);

  tslib.__decorate([tracksTransactionsWithOptions({
    numArguments: 3
  }), tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object]), tslib.__metadata("design:returntype", void 0)], ManagedCdpClass.prototype, "lockAndDraw", null);

  tslib.__decorate([tracksTransactionsWithOptions({
    numArguments: 3
  }), tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object]), tslib.__metadata("design:returntype", void 0)], ManagedCdpClass.prototype, "wipeAndFree", null);

  tslib.__decorate([tracksTransactionsWithOptions({
    numArguments: 1
  }), tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object]), tslib.__metadata("design:returntype", void 0)], ManagedCdpClass.prototype, "wipeAllAndFree", null);
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                assert(lockAmount instanceof currency.Currency, 'lockAmount must be a Currency value');
                drawAmount = castAsCurrency(drawAmount, DAI);
                _context8.next = 7;
                return this.get('proxy').ensureProxy({
                  promise: promise
  ...
  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object]), tslib.__metadata("design:returntype", Promise)], CdpManager.prototype, "open", null);

  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object]), tslib.__metadata("design:returntype", Promise)], CdpManager.prototype, "reclaimCollateral", null);

  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object, Object]), tslib.__metadata("design:returntype", Promise)], CdpManager.prototype, "openLockAndDraw", null);

  tslib.__decorate([tracksTransactionsWithOptions({
    numArguments: 5
  }), tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object, Object, Object]), tslib.__metadata("design:returntype", Promise)], CdpManager.prototype, "lockAndDraw", null);

  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object, Object, Object]), tslib.__metadata("design:returntype", Promise)], CdpManager.prototype, "lock", null);

  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object, Object]), tslib.__metadata("design:returntype", Promise)], CdpManager.prototype, "draw", null);

  tslib.__decorate([tracksTransactionsWithOptions({
    numArguments: 5
  }), tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object, Object, Object]), tslib.__metadata("design:returntype", void 0)], CdpManager.prototype, "wipeAndFree", null);

  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object, Object]), tslib.__metadata("design:returntype", Promise)], CdpManager.prototype, "wipe", null);

  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object]), tslib.__metadata("design:returntype", void 0)], CdpManager.prototype, "unsafeWipe", null);

  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object]), tslib.__metadata("design:returntype", Promise)], CdpManager.prototype, "wipeAll", null);

  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object]), tslib.__metadata("design:returntype", void 0)], CdpManager.prototype, "unsafeWipeAll", null);

  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object, Object]), tslib.__metadata("design:returntype", void 0)], CdpManager.prototype, "wipeAllAndFree", null);

  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object]), tslib.__metadata("design:returntype", void 0)], CdpManager.prototype, "give", null);

  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object, Object]), tslib.__metadata("design:returntype", void 0)], CdpManager.prototype, "giveToProxy", null);
  ...
  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object]), tslib.__metadata("design:returntype", Promise)], SavingsService.prototype, "join", null);

  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object, Object]), tslib.__metadata("design:returntype", Promise)], SavingsService.prototype, "exit", null);

  tslib.__decorate([tracksTransactions, tslib.__metadata("design:type", Function), tslib.__metadata("design:paramtypes", [Object]), tslib.__metadata("design:returntype", Promise)], SavingsService.prototype, "exitAll", null);
  ...
  exports.LRC = LRC$3;
  exports.MANA = MANA$3;
  exports.MATIC = MATIC$3;
  exports.MKR = MKR;
  exports.McdPlugin = McdPlugin;
  exports.OMG = OMG$1;
  exports.PAXUSD = PAXUSD$3;
  exports.RENBTC = RENBTC$3;
  exports.REP = REP$1;
  exports.SAI = SAI$2;
  exports.ServiceRoles = ServiceRoles$1;
  exports.TUSD = TUSD$3;
  exports.UNI = UNI$3;
  exports.UNIV2AAVEETH = UNIV2AAVEETH$3;
  exports.UNIV2DAIETH = UNIV2DAIETH$3;
  exports.UNIV2DAIUSDC = UNIV2DAIUSDC$3;
  exports.UNIV2DAIUSDT = UNIV2DAIUSDT$3;
  exports.UNIV2ETHUSDT = UNIV2ETHUSDT$3;
  exports.UNIV2LINKETH = UNIV2LINKETH$3;
  exports.UNIV2UNIETH = UNIV2UNIETH$3;
  exports.UNIV2USDCETH = UNIV2USDCETH$3;
  exports.UNIV2WBTCDAI = UNIV2WBTCDAI$3;
  exports.UNIV2WBTCETH = UNIV2WBTCETH$3;
  exports.USD = USD;
  exports.USDC = USDC$3;
  exports.USDT = USDT$3;
  ...
  exports.WBTC = WBTC$3;
  exports.WETH = WETH;
  exports.WSTETH = WSTETH$3;
  exports.YFI = YFI$3;
  exports.ZRX = ZRX$3;
  exports.default = McdPlugin;
...
//# sourceMappingURL=dai-plugin-mcd.umd.development.js.map
